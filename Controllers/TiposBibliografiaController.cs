...
namespace Biblioteca.Controllers
{
    public class TiposBibliografiaController : Controller
    {
        ...
        public TiposBibliografiaController(SqlDatabaseBibliotecaContext context)
        {
            _context = context;
        }

        // GET: TiposBibliografia
        public async Task<IActionResult> Index()
        {
            return View(await _context.TiposBibliografia.ToListAsync());
        }

        // GET: TiposBibliografia/Details/5
        ...
        // GET: TiposBibliografia/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TiposBibliografia/Create
        ...
        // GET: TiposBibliografia/Delete/5
        ...
        // POST: TiposBibliografia/Delete/5
